...
function ChatbotTab() {
  ...
  const send = async () => {
    ...
    try {
      ...
      const d = await r.json()
      const reply = d.response || d.detail || 'Ցավոք, պատասխան չստացվեց։ Կրկին փորձեք։'
 ...
 const suggestions = [
  'Հայաստանի ամենահին պահպանված եկեղեցին ո՞րն է',
  'Ո՞ր հայկական եկեղեցիներն են այսօր կիսավեր կամ ավերված',
  'Արագածոտնի ո՞ր գյուղերն ունեն միջնադարյան եկեղեցիներ',
  '7-րդ դարի հայկական եկեղեցիներից որո՞նք են պահպանվել',
  'Ո՞ր հայկական եկեղեցիներն են կառուցվել իշխանների կողմից'
]
